...
Детальное описание базовой теории по теме, точные формулировки заданий и списки вариантов Вы можете найти в файле [**Practice.pdf**](Practice.pdf) ([**Practice_compressed.pdf**](Practice_compressed.pdf) для открытия в браузере), а примеры графиков в высоком качестве -- в директории [**Examples**](Examples/Comments.md).
